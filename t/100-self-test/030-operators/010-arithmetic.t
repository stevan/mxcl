...
my $source = q[
    ...
    (diag "Multiplication tests (infix)")
    (is (3 * 4)     12      "... 3 * 4 = 12")
    (is (2.5 * 4)   10      "... 2.5 * 4 = 10")
    (is (-3 * 4)    -12     "... -3 * 4 = -12")
    (is (-3 * -4)   12      "... -3 * -4 = 12")
    ...
    (diag "Nested arithmetic tests (infix)")
    (is (1 + (2 * 3))               7   "... 1 + (2 * 3) = 7")
    (is ((1 + 2) * (3 + 4))         21  "... (1+2) * (3+4) = 21")
    (is ((10 * 10) - (50 + 50))     0   "... (10*10) - (50+50) = 0")
    (is ((10 + 20) / (10 - 5))      6   "... (10+20) / (10-5) = 6")
